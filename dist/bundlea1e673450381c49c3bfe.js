...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Inter:wght@700&display=swap);"]);
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n    --darker: #1A1D33;\n    --lighter: #105F82;\n    --lightest: #00ACBB;\n}\n\nbody {\n    background-color: var(--darker);\n    display: grid;\n    grid-template-columns: 1fr 3fr;\n    font-family: 'Inter', sans-serif;\n}\n\n.sidebar {\n    grid-column: 1 / 2;\n    background-color: var(--lighter);\n    color: white;\n    height: max(100%, 100vh);\n    padding: 0px 30px;\n    display: flex;\n    flex-direction: column;\n}\n\n.top {\n    display: flex;\n    font-size: 1.8rem;\n    margin-top: 0px;\n    padding-top: 0px;\n    gap: 10px;\n}\n\nform > div {\n    display: flex;\n    flex-direction: column;\n    margin-top: 20px;\n    gap: 10px;\n}\n\n#radio {\n    display: block;\n    padding-bottom: 20px;\n}\n\n#radio > div > label:not(:first-child){\n    font-size: 1rem;\n}\n\n#radio > div {\n    margin-bottom: 10PX;\n\n}\n\nlabel, #radio-label {\n    font-size: 1.3rem;\n    \n}\n\n\ninput {\n    background-color: var(--darker);\n    border: none;\n    width: 300px;\n    color: white;\n    height: 1.5rem;\n}\n\n#logo {\n    height: 80px;\n    align-self: center;\n}\n\ninput[type=\"radio\"] {\n    margin-right: 5px;\n    margin-left: 20px;\n    width: 18px;\n    vertical-align: text-bottom;\n\n}\n\nbutton {\n    background-color: var(--lightest);\n    border: none;\n    padding: 5px 10px;\n    height: 50px;\n    color: white;\n}\n\n.main {\n    grid-column: 2 / 3;\n    padding: 50px;\n}\n\ntable {\n    color: white;\n    text-align: center;\n    margin-left: auto;\n    margin-right: auto;\n    border-collapse: collapse;\n\n}\n\nthead {\n    font-size: 1.3rem;\n    background-color: var(--lighter);\n    border: none;\n\n}\n\nth {\n    padding: 10px 30px;\n    margin-left: 40px;\n}\n\nth:first-of-type {\n    padding: 10px 200px;\n}\n\ntd {\n    padding-top: 15px;\n    padding-bottom: 15px;\n    border-bottom: 4px solid #105F82;\n}", "",{"version":3,"sources":["webpack://./src/styles/style.css"],"names":[],"mappings":"AAGA;IACI,iBAAiB;IACjB,kBAAkB;IAClB,mBAAmB;AACvB;;AAEA;IACI,+BAA+B;IAC/B,aAAa;IACb,8BAA8B;IAC9B,gCAAgC;AACpC;;AAEA;IACI,kBAAkB;IAClB,gCAAgC;IAChC,YAAY;IACZ,wBAAwB;IACxB,iBAAiB;IACjB,aAAa;IACb,sBAAsB;AAC1B;;AAEA;IACI,aAAa;IACb,iBAAiB;IACjB,eAAe;IACf,gBAAgB;IAChB,SAAS;AACb;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,gBAAgB;IAChB,SAAS;AACb;;AAEA;IACI,cAAc;IACd,oBAAoB;AACxB;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,mBAAmB;;AAEvB;;AAEA;IACI,iBAAiB;;AAErB;;;AAGA;IACI,+BAA+B;IAC/B,YAAY;IACZ,YAAY;IACZ,YAAY;IACZ,cAAc;AAClB;;AAEA;IACI,YAAY;IACZ,kBAAkB;AACtB;;AAEA;IACI,iBAAiB;IACjB,iBAAiB;IACjB,WAAW;IACX,2BAA2B;;AAE/B;;AAEA;IACI,iCAAiC;IACjC,YAAY;IACZ,iBAAiB;IACjB,YAAY;IACZ,YAAY;AAChB;;AAEA;IACI,kBAAkB;IAClB,aAAa;AACjB;;AAEA;IACI,YAAY;IACZ,kBAAkB;IAClB,iBAAiB;IACjB,kBAAkB;IAClB,yBAAyB;;AAE7B;;AAEA;IACI,iBAAiB;IACjB,gCAAgC;IAChC,YAAY;;AAEhB;;AAEA;IACI,kBAAkB;IAClB,iBAAiB;AACrB;;AAEA;IACI,mBAAmB;AACvB;;AAEA;IACI,iBAAiB;IACjB,oBAAoB;IACpB,gCAAgC;AACpC","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Inter:wght@700&display=swap');\n\n\n:root {\n    --darker: #1A1D33;\n    --lighter: #105F82;\n    --lightest: #00ACBB;\n}\n\nbody {\n    background-color: var(--darker);\n    display: grid;\n    grid-template-columns: 1fr 3fr;\n    font-family: 'Inter', sans-serif;\n}\n\n.sidebar {\n    grid-column: 1 / 2;\n    background-color: var(--lighter);\n    color: white;\n    height: max(100%, 100vh);\n    padding: 0px 30px;\n    display: flex;\n    flex-direction: column;\n}\n\n.top {\n    display: flex;\n    font-size: 1.8rem;\n    margin-top: 0px;\n    padding-top: 0px;\n    gap: 10px;\n}\n\nform > div {\n    display: flex;\n    flex-direction: column;\n    margin-top: 20px;\n    gap: 10px;\n}\n\n#radio {\n    display: block;\n    padding-bottom: 20px;\n}\n\n#radio > div > label:not(:first-child){\n    font-size: 1rem;\n}\n\n#radio > div {\n    margin-bottom: 10PX;\n\n}\n\nlabel, #radio-label {\n    font-size: 1.3rem;\n    \n}\n\n\ninput {\n    background-color: var(--darker);\n    border: none;\n    width: 300px;\n    color: white;\n    height: 1.5rem;\n}\n\n#logo {\n    height: 80px;\n    align-self: center;\n}\n\ninput[type=\"radio\"] {\n    margin-right: 5px;\n    margin-left: 20px;\n    width: 18px;\n    vertical-align: text-bottom;\n\n}\n\nbutton {\n    background-color: var(--lightest);\n    border: none;\n    padding: 5px 10px;\n    height: 50px;\n    color: white;\n}\n\n.main {\n    grid-column: 2 / 3;\n    padding: 50px;\n}\n\ntable {\n    color: white;\n    text-align: center;\n    margin-left: auto;\n    margin-right: auto;\n    border-collapse: collapse;\n\n}\n\nthead {\n    font-size: 1.3rem;\n    background-color: var(--lighter);\n    border: none;\n\n}\n\nth {\n    padding: 10px 30px;\n    margin-left: 40px;\n}\n\nth:first-of-type {\n    padding: 10px 200px;\n}\n\ntd {\n    padding-top: 15px;\n    padding-bottom: 15px;\n    border-bottom: 4px solid #105F82;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/***/ "./src/assets/library-outline.svg":
/*!****************************************!*\
  !*** ./src/assets/library-outline.svg ***!
  \****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "library-outline.svg";
...
/* harmony import */ var _assets_library_outline_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./assets/library-outline.svg */ "./src/assets/library-outline.svg");



var myLibrary = []; //Array for books
var i = 0;
...
function switchStatus(j) {
  var status = document.getElementById("finish" + j);
...
function addBookToLibrary() {
  ...
  if (read == "yes") document.getElementById("finish" + i).style.color = "green";else document.getElementById("finish" + i).style.color = "red";
  form.reset();
  console.log(read);
}
...
/******/ })()
;
//# sourceMappingURL=bundlea1e673450381c49c3bfe.js.map